...
<footer class="cadastrofooter1">
 ...
 <form class="cadastroform1 text-center" method="post" action="{{route('salvar-banco')}}">
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-5">
        <input  name="modelo" value="{{old('modelo', $registrosCaminhoes->modelo)}}" class="email form-control bg-light" placeholder="V8">
        @error('modelo')
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-5">
          <input name="marca" value="{{old('marca', $registrosCaminhoes->marca)}}" class="email form-control bg-light" id="inputPassword3" placeholder="Scania">
          @error('marca')
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-5">
          <input name="ano" value="{{old('ano', $registrosCaminhoes->ano)}}" class="email form-control bg-light"   placeholder="2021">
          @error('ano')
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-5">
          <input name="cor" value="{{old('cor', $registrosCaminhoes->cor)}}" class="email form-control bg-light" placeholder="vermelho">
          @error('cor')
